...
checkpoint = torch.load('../outputs/Epoch_20_MobileNetv3/epoch_20_MobileNetv3.pth', map_location=DEVICE)
...
for i in range(len(test_images)):
    ...
    if len(outputs[0]['boxes']) != 0:
        ...
        cv2.waitKey(1)
        cv2.imwrite(f"../inference_outputs/images_MobileNetv3_epoch_20/{image_name}.jpg", orig_image)
